 ...
 *
 * Терминология.
 * id - текст вида: "r2" или "w5". Однозначно определяет изображение карты.
 * name - идентификатор карты на руке; от 0 до 4. Используется для простого однозначного указания на карту в моей руке или руке оппонента.
